...
async function main() {
    await applySqlFile('20260408150000_hrm_leave_management.sql');
    await applySqlFile('20260408153000_hrm_requests.sql');
    await applySqlFile('20260408160000_seed_mock_hrm_data.sql');
    console.log('\n🎉 ALL HRM Migrations applied!');
}
