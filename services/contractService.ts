...
// Re-export extracted sub-modules for backward compatibility
// Consumers can also import directly from './contract/*'
export { getEmployeeSharePct } from './contract/contractFinancials';
...
// mapContract is now imported from './contract/contractMapper'
