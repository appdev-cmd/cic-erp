...
const GLOBAL_ROLES = [ADMIN, LEADERSHIP, LEGAL, ACCOUNTANT, CHIEF_ACCOUNTANT, MARKETING, BACK_OFFICE];
const FINANCE_ROLES = [ADMIN, LEADERSHIP, ACCOUNTANT, CHIEF_ACCOUNTANT, LEGAL, BACK_OFFICE];
const HR_ROLES = [ADMIN, LEADERSHIP, BACK_OFFICE];
