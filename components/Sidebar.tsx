...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const managementItems = NAV_ITEMS.filter(item => ['dashboard', 'website', 'tasks', 'projects', 'contracts', 'payments', 'analytics', 'documents', 'hrm', 'ai-assistant', 'tech-intel', 'tools', 'crm'].includes(item.id) && !hiddenItems.has(item.id) && (!item.devOnly || isDevLocal));
