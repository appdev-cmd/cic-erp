...
const RESOURCES: PermissionResource[] = ['contracts', 'employees', 'units', 'customers', 'products', 'payments', 'settings', 'permissions', 'reports', 'news', 'projects', 'requests', 'leaves', 'recruitment', 'tasks', 'analytics', 'crm'];
        ...
        <div className="space-y-6">
                        ...
                        <div className="mt-5 pt-4 border-t border-amber-200 dark:border-amber-700">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                {RESOURCES.map(resource => {
                                    ...
                                    return (
                                        <div key={resource} className={`rounded-lg p-2 text-xs ${actions.length > 0 ? 'bg-white dark:bg-slate-900' : 'bg-slate-100 dark:bg-slate-800 opacity-50'}`}>
            ...
            <div className="relative">
                ...
                {isDropdownOpen && !loading && (
                    <div className="absolute z-50 w-full mt-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg shadow-2xl dark:shadow-black/40 overflow-hidden">
                        ...
                        <div className="p-3 border-b border-slate-100 dark:border-slate-700">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 pr-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm text-slate-800 dark:text-slate-200"
                                    autoFocus
                                />
                            </div>
                        </div>
