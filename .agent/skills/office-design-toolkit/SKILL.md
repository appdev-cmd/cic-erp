...
description: Office Design Toolkit — Tạo tài liệu DOCX/XLSX/PPTX/PDF chuyên nghiệp với quy trình 4 bước (Content → Structure → Design → QA)
---
...
- Do NOT insert internal style/theme guidance text into the document body unless user explicitly asks
