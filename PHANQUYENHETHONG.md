...
graph LR
    subgraph "Quy tắc phạm vi dữ liệu"
        ...
        B -->|NVKD, NVKT, AdminUnit, UnitLeader| C["Chỉ xem dữ liệu<br/>Đơn vị X"]
...
| Nội dung | Ban điều hành | Phòng ban hỗ trợ | Đơn vị (NVKD, NVKT, AdminUnit, UnitLeader) |
|----------|:---:|:---:|:---:|
...
#### Phạm vi xem
| Phạm vi | NVKD | NVKT | AdminUnit | UnitLeader | Kế toán | Pháp chế | BackOffice | Lãnh đạo | Admin |
|---------|:----:|:----:|:---------:|:----------:|:-------:|:--------:|:----------:|:--------:|:-----:|
| HĐ đơn vị mình | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| HĐ toàn công ty | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ |
| HĐ đơn vị được cấp quyền | ✅ *(chỉ xem)* | ✅ *(chỉ xem)* | ✅ *(chỉ xem)* | ✅ *(chỉ xem)* | — | — | — | — | — |
#### Quyền thao tác
| Hành động | NVKD | NVKT | AdminUnit | UnitLeader | Kế toán | Pháp chế | BackOffice | Lãnh đạo | Admin |
|-----------|:----:|:----:|:---------:|:----------:|:-------:|:--------:|:----------:|:--------:|:-----:|
...
| Hành động | Lãnh đạo | Admin | Các vai trò khác |
|-----------|:--------:|:-----:|:----------------:|
| Xem | ✅ | ✅ | ✅ |
| Tạo mới | ✅ | ✅ | ✅ |
| Chỉnh sửa | ✅ | ✅ | ✅ |
| Xóa | ✅ | ✅ | ❌ |
> [!NOTE]
> Dữ liệu khách hàng được **chia sẻ toàn công ty** (không phân chia theo đơn vị). Chỉ Lãnh đạo và Admin được **xóa**.
...
#### Ma trận phân quyền
| Hành động | NVKD | NVKT | AdminUnit | UnitLeader | Accountant | ChiefAccountant | Lãnh đạo | Admin |
|-----------|:----:|:----:|:---------:|:----------:|:----------:|:---------------:|:--------:|:-----:|
...
> [!IMPORTANT]
> **Nguyên tắc phân tách:** Bộ phận kinh doanh (NVKD, AdminUnit, UnitLeader) chỉ nhập **kế hoạch/dự kiến**. NVKT chỉ có quyền **xem** thanh toán. Bộ phận Kế toán chịu trách nhiệm **ghi nhận thực tế** — đảm bảo tính chính xác và tuân thủ quy trình tài chính.
### 6.5. Nhân sự (`employees`)
Chỉ **Ban lãnh đạo**, **Quản trị viên** và **Trưởng phòng Tổng hợp** (phụ trách nhân sự) được truy cập. Các vai trò khác **không được xem**.
| Hành động | Lãnh đạo | Admin | Trưởng P. Tổng hợp | Các vai trò khác |
|-----------|:--------:|:-----:|:-------------------:|:----------------:|
| Xem | ✅ | ✅ | ✅ | ❌ |
| Tạo mới | ✅ | ✅ | ✅ | ❌ |
| Chỉnh sửa | ✅ | ✅ | ✅ | ❌ |
| Xóa | ✅ | ✅ | ✅ | ❌ |
### 6.6. Đơn vị (`units`)
Chỉ **Ban lãnh đạo** và **Quản trị viên** được truy cập. Các vai trò khác **không được xem**.
| Hành động | Lãnh đạo | Admin | Các vai trò khác |
|-----------|:--------:|:-----:|:----------------:|
| Xem | ✅ | ✅ | ❌ |
| Tạo mới | ✅ | ✅ | ❌ |
